...
def test_pytest_available():
    ...
    try:
        ...
        if result.returncode == 0:
            print("PASS: Pytest is available")
            return True
        else:
            print("FAIL: Pytest not working properly")
            return False
    except Exception as e:
        print(f"FAIL: Pytest test failed: {e}")
        return False
...
def test_project_structure():
    ...
    if missing_paths:
        print(f"FAIL: Missing required paths: {missing_paths}")
        return False
    else:
...
def test_imports():
    ...
    try:
        ...
        print("PASS: New test modules import successfully")
        return True
